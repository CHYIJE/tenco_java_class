...
public class MySetTest {
	...
	public static void main(String[] args) {
		...
		// 계층구조 확인
		// 업 캐스팅 된 상태 = 컴파일 시점에는 Set 계열에 타입은 멤버(ex : HashSet)들만 확인 가능
		...
		// 확인해보면 난 5개를 넣었지만 중복값 발생으로 3개가 된다
		// 즉 중복값이 허용된다
		...
		// set은 인덱스로 for문을 돌릴 수 없지만 for each를 통해 가능
		for (Integer mI : set1) {
...
//		}
		...
		System.out.println("반복횟수 : " + whileCount);
